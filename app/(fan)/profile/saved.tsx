// app/(fan)/profile/saved.tsx — Saved Content / Bookmarks Screen
  ...
  const { data, isLoading, refetch } = useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        return fallbackRes.data?.posts?.filter((p: any) => p.viewerSaved) ?? []
      }
    },
  })
          ...
          ListEmptyComponent={
            <View style={styles.emptyBox}>
              <View style={styles.emptyIconWrap}>
                <Bookmark size={36} color="#8B5CF6" fill="#EDE9FE" />
              </View>
              <Text style={styles.emptyTitle}>No saved content yet</Text>
              <Text style={styles.emptySub}>
                Bookmark posts and videos to easily find and enjoy them later.
              </Text>
              <TouchableOpacity
                ...
                activeOpacity={0.85}
              >
                <Text style={styles.exploreBtnText}>Discover Content</Text>
              </TouchableOpacity>
            </View>
          }
